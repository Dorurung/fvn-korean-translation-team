...
const projectData = [
  { id: 1, title: "Adastra", image: "/fvn-korean-translation-team/assets/projects/adastra.png", banner_image: "/fvn-korean-translation-team/assets/projects/adastra_banner.png",
  ...
  { id: 2, title: "Interea", image: "/fvn-korean-translation-team/assets/projects/interea.webp", banner_image: "/fvn-korean-translation-team/assets/projects/interea_banner.png",
  ...
  { id: 3, title: "Khemia", image: "/fvn-korean-translation-team/assets/projects/khemia.png", banner_image: "/fvn-korean-translation-team/assets/projects/khemia_banner.png",
    description: "케미아는 아다스트라의 시퀄입니다.\n멘헤라? 주인공 스키피오와 능글능글한 네페루의 케미를 감상해봐요.",
    originalLink: "https://echoproject.itch.io/khemia",
    status: "완료(0.1버전)",
  },
  { id: 4, title: "The Smoke Room", image: "/fvn-korean-translation-team/assets/projects/tsr.png", banner_image: "/fvn-korean-translation-team/assets/projects/tsr_banner.png",
  ...
  { id: 5, title: "Arches", image: "/fvn-korean-translation-team/assets/projects/arches.png", banner_image: "/fvn-korean-translation-team/assets/projects/arches_banner.png",
  ...
  { id: 6, title: "Echo", image: "/fvn-korean-translation-team/assets/projects/echo.png", banner_image: "/fvn-korean-translation-team/assets/projects/echo_banner.png",
  ...
  { id: 7, title: "Remember the Flowers", image: "/fvn-korean-translation-team/assets/projects/rtf.gif", banner_image: "/fvn-korean-translation-team/assets/projects/rtf_banner.png",
  ...
  { id: 8, title: "Burrows", image: "/fvn-korean-translation-team/assets/projects/burrows.png", banner_image: "/fvn-korean-translation-team/assets/projects/burrows_banner.png",
...
const teamMemberData = [
  { id: 1, name: "도루룽", image: "/fvn-korean-translation-team/assets/members/dorurung.png", description: "아다스트라를 너무 감명 깊게 플레이해서 시작한 번역 프로젝트인데.. 스케일이 끝도없이 커지고 있다!", job: "프로그래머", discord: "Dorurung#6690", telegram: "@dorurung"},
  { id: 2, name: "Husky", image: "/fvn-korean-translation-team/assets/members/husky.jpg", description: "", job: "번역가"},
  { id: 3, name: "늑발", image: "/fvn-korean-translation-team/assets/members/nukbal.jpg", description: "", job: "프로그래머", twitter: "https://x.com/frostwolfclaw"},
  { id: 4, name: "Nelson", image: "/fvn-korean-translation-team/assets/members/nelson.png", description: "", job: "번역가", twitter: "https://x.com/ultim8nelson"},
  { id: 5, name: "레드벨", image: "/fvn-korean-translation-team/assets/members/redbell.png", description: "", job: "번역가"}
]
    ...
    <div className="min-h-screen bg-gray-100 flex justify-center">
      <div className="max-w-3xl w-full">
        <nav className="bg-white shadow-md flex justify-around">
          <Link to="/fvn-korean-translation-team" className="p-4 w-full text-center text-blue-500 hover:bg-gray-200">팀 소개</Link>
          <Link to="/fvn-korean-translation-team/projects" className="p-4 w-full text-center text-blue-500 hover:bg-gray-200">프로젝트</Link>
        </nav>
        <AnimatePresence mode="wait">
          <Routes location={location} key={location.pathname}>
            <Route path="/fvn-korean-translation-team" element={<Team />} />
            <Route path="/fvn-korean-translation-team/projects" element={<Projects />} />
          </Routes>
        </AnimatePresence>
      </div>
    </div>
