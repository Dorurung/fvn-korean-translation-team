  ...
  return (
    <motion.div className="p-4 text-center" {...pageTransition()}>
      ...
      <div className="grid grid-cols-2 gap-4 mt-4">
        {projectData.filter((project) => !!project).map((project) => (
          <button
            key={project.id}
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex justify-center">
      <div className="max-w-3xl w-full">
        <nav className="p-4 bg-white shadow-md flex justify-around">
          <Link to="/" className="text-blue-500">팀 소개</Link>
          <Link to="/projects" className="text-blue-500">프로젝트</Link>
        </nav>
        <AnimatePresence mode="wait">
